# -*- coding: utf-8 -*-
"""All_App_Reviews_Star_Calculation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1tQxCJdQskF0qufmt3uY9mg4ewf4RK4Tv
...
for i in range(0,len(df)-1):
  try:
    X_data.append(df.iloc[i]['Reviews'])
    Y_data.append(df.iloc[i]['Rating'])
...
import pickle
pickle_out = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/X_All_R.pickle", "wb")
...
pickle_out = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Y_All_R.pickle", "wb")
