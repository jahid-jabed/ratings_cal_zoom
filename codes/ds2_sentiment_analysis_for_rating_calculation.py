# -*- coding: utf-8 -*-
"""Second_Sentiment_Analysis.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ajpzM_njhQeGG1rpRYBle4nXvQ7eBPXx
...
for i in range(2,len(df)):
  try:
    ...
    if (Y_out>=3 and Y_true>=3) or (Y_out<3 and Y_true<3):
      if Y_true == 1 and one < count:
        X_data.append(df['Reviews'].iloc[i])
        Y_data.append(Y_true)
        Y_score.append(Y_out)
        one = one + 1
      elif Y_true == 2 and two < count:
        X_data.append(df['Reviews'].iloc[i])
        Y_data.append(Y_true)
        Y_score.append(Y_out)
        two = two + 1
      elif Y_true == 3 and three < count:
        X_data.append(df['Reviews'].iloc[i])
        Y_data.append(Y_true)
        Y_score.append(Y_out)
        three = three + 1
      elif Y_true == 4 and four < count:
        X_data.append(df['Reviews'].iloc[i])
        Y_data.append(Y_true)
        Y_score.append(Y_out)
        four = four + 1
      elif Y_true == 5 and five < count:
        X_data.append(df['Reviews'].iloc[i])
        Y_data.append(Y_true)
        Y_score.append(Y_out)
        five = five + 1
...
pickle_out = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/X.pickle", "wb")
...
pickle_out = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/Y.pickle", "wb")
...
pickle_out = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/Y_score.pickle", "wb")
...
pickle_out = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/X_train.pickle", "wb")
...
pickle_out = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/Y_train.pickle", "wb")
...
pickle_out = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/X_test.pickle", "wb")
...
pickle_out = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/Y_test.pickle", "wb")
...
pickle_out = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/X_val.pickle", "wb")
...
pickle_out = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/Y_val.pickle", "wb")
...
pickle_in = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/X_train.pickle", "rb")
X_train = pickle.load(pickle_in)

pickle_in = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/Y_train.pickle", "rb")
Y_train = pickle.load(pickle_in)

pickle_in = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/X_test.pickle", "rb")
X_test = pickle.load(pickle_in)

pickle_in = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/Y_test.pickle", "rb")
Y_test = pickle.load(pickle_in)

pickle_in = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/X_val.pickle", "rb")
X_val = pickle.load(pickle_in)

pickle_in = open("/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/Y_val.pickle", "rb")
...
model.add(layers.LSTM(128, dropout=0.2, recurrent_dropout=0.2, return_sequences=True, name='lstm'))
...
filepath = '/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/model-{epoch:02d}-performance-{val_accuracy:.2f}-{val_loss:.2f}.hdf5'
...
model.save('/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/model-15-performance-0.43-1.33.h5') #save weights
...
filepath = '/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/model-15+{epoch:02d}-performance-{val_accuracy:.2f}-{val_loss:.2f}.hdf5'
...
model.save('/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/model-v2-15-performance-0.42-1.39.h5') #save weights
...
model = tf.keras.models.load_model('/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/model-v2-15-performance-0.42-1.39.h5')
...
filepath = '/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/model-30+{epoch:02d}-performance-{val_accuracy:.2f}-{val_loss:.2f}.hdf5'
...
model.save('/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/Model_2/model-v3-30-performance-0.45-1.91.h5') #save weights
