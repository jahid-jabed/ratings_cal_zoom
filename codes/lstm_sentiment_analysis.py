...
Original file is located at
    https://colab.research.google.com/drive/124EA7nEEv3n-IfsG34sbLib8QAPgyBa9
...
model.add(layers.LSTM(128, dropout=0.2, recurrent_dropout=0.2, name='lstm1'))
...
filepath = '/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/LSTM/model_lstm-{epoch:02d}-performance-{val_accuracy:.2f}-{val_loss:.2f}.hdf5'
...
model = tf.keras.models.load_model('/content/drive/MyDrive/SQA/Project Works/Datasets/Pickle Data/LSTM/model_lstm-14-performance-0.47-1.31.hdf5')
